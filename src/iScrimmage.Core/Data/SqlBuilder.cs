...
{
    /// <summary>
    /// From: https://github.com/SamSaffron/dapper-dot-net/blob/master/Dapper.SqlBuilder/SqlBuilder.cs
    /// </summary>
    public class SqlBuilder
    {
        ...
        public SqlBuilder Select(List<String> fields, dynamic parameters = null)
        {
            fields.ForEach(p => Select(p));
            return this;
        }
